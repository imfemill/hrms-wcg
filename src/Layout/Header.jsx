      ...
      <div className="lg:pl-14 xl:pl-[14%]">
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <form className="relative flex flex-1 py-3" action="#" method="GET">
              ...
              <input
                id="search-field"
                className="block h-full border-0 py-0 pl-8 pr-2 text-gray-900 placeholder:text-gray-400 outline-0 focus:ring-1 rounded-xl sm:text-sm"
                placeholder="Search..."
                type="search"
                name="search"
              />
