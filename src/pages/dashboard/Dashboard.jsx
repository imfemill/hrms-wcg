    ...
    <>
      <div className="select-none w-full flex-wrap">
        <div className="columns-1 flex max-lg:flex-col">
          <div className="w-2/3 max-lg:w-full flex gap-4 flex-wrap order-1 max-lg:order-2 content-start justify-center bg-wcg_navy/5 min-h-[100%]">
          </div>
