      ...
      <div>
        ...
        <div className="flex justify-between  py-1">
          <div >
            ...
            <button onClick={goToToday} className="mx-2 p-2" >today</button>
          ...
          <div>
            <button onClick={goToMonthView}  className="mx-2" >month</button>
            <button onClick={goToWeekView}  className="mx-2" >week</button>
            <button onClick={goToDayView}  className="mx-2" >day</button>
          </div>
        </div>
        <div></div>
      </div>
